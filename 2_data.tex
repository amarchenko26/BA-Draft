...
I restricted the sample to hosts who have profile pictures and manage less than 20 listings, and listings priced at less than \$800 per night. 45,076 listings were left after restricting the data set. Only 20 hosts did not have profile pictures. [NOTE TO SELF CHECK THAT THIS IS TRUE IN FINAL VERSION. NOTE TO SELF ALSO CHECK FOR JUST ADDING ZIPCODE FE RATHER THAN CENSUS DATA]
...
I argue that adding neighborhood fixed effects demeans any effect on price that is due to listings in that that neighborhood being proximate to downtown, any tourist attractions, etc. Moreover,  However, some neighborhoods may  be large, and have more desirable and less desirable 

To further control for characteristics of a listing's location that may differentially impact price by race, I merge in Census data from the American Community Survey 2016 5-year zip-code level estimates. 

I add variables that include (1) demographic (\% of population by race) (2) median income (z-score), (3) population density, (4) unemployment rate for the total labor force, (4) \% of households on Supplemental Security Income, (5) occupancy rate for housing units, Median Value, gross rent, commuting time to work. 
