...

{
	\begin{longtable}{l*{5}{c}}
		\caption{Summary Statistics by Race: Reviewer Characteristics} \label{table:reviewer:}\\
		\hline
		...
		[1em]
		Host race            &            &         &      &      &	         \\
		\hspace{3mm}White     &.726 &  .734    &  .605  &    .650   &      .657 	   \\
		\hspace{3mm}Black     & .058 &    .050   &   .148   &   .057   &     .060	  \\
		\hspace{3mm}Hispanic   &.045 &  .045    &   .045  &   .072  &     .056      \\
		\hspace{3mm}Asian     & .051    &   .047    &      .069    &   .076   &  .098 	    \\
		\hspace{3mm}Unknown     &.118 &     .123   &       .132  &  .145   &  .127      \\
		[1em]
