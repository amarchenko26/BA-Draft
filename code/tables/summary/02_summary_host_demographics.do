...
file write f " \hspace{10bp}Unknown & " 	%4.2f (`race_res_mean_0') " & {0} & {0} &  {0}  & {0}  & {0} \\ " 	

file write f " Sex &&&&&& \\" _n
file write f " \hspace{10bp}Male & " 	%4.2f (`sex_mean_1') " & " %4.2f (`sex_mean_all_1') " &  " %4.2f (`sex_mean_1_1') " & " %4.2f (`sex_mean_2_1') " &  " %4.2f (`sex_mean_3_1') " & " %4.2f (`sex_mean_4_1') " \\ " 
file write f " \hspace{10bp}Female & " 	%4.2f (`sex_mean_2') " & " %4.2f (`sex_mean_all_2') " &  " %4.2f (`sex_mean_1_2') " & " %4.2f (`sex_mean_2_2') " &  " %4.2f (`sex_mean_3_2') " & " %4.2f (`sex_mean_4_2') " \\ " 
file write f " \hspace{10bp}Unknown & "	%4.2f (`sex_mean_0') " & {0} & {0} &  {0}  & {0}  & {0} \\ "
...
file write f " \hspace{10bp}Unknown & " 	%4.2f (`age_res_mean_0') " & {0} & {0} &  {0}  & {0}  & {0} \\ " 	
