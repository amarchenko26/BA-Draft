...
#delimit ;
esttab model1 model2 model3 model4 using "$repository/code/tables/output/number_reviews.tex", 
		...
		labels("Location Fixed Effects" "Property Fixed Effects" "Host Fixed Effects" 
			"\hline \vspace{-1.25em}" "Observations" "Adjusted R2"))  
		fragment
;
#delimit cr
