...
// Esttab the table
#delimit ;
esttab model1 model2 model3 model4 model5 using "$repository/code/output/price.tex", 
	se ar2 replace label 
	keep(*.race_sex_res) drop(1.race_sex_res)
	mtitles("Model 1" "Model 2" "Model 3" "Model 4" "Model 5")
	stats(controlgroup1 controlgroup2 controlgroup3 N r2,
	labels("Location Fixed Effects" "Property Fixed Effects" 
		   "Host Fixed Effects" "Observations" "Adjusted R2"))
	fragment 
;
#delimit cr
