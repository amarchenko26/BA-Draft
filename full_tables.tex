...
\begin{table}[htbp]\centering
	...
	\begin{tabular}{c|ccccc}
		...
		\input{code/tables/output/price.tex}
...
\begin{table}[htbp]\centering
	...
	\begin{tabular}{c|c}
		...
		\input{code/tables/output/edelman_price.tex}
...
\begin{table}[htbp]\centering
	...
	\begin{tabular}{c|ccccc}
		...
		\input{code/tables/output/number_reviews.tex}
...
\begin{table}[htbp]\centering
	...
	\label{table: 30 Day Availibilitu}
	\begin{tabular}{c|c}
		\toprule
		
		\input{code/tables/output/availibility_30_days.tex}
...
\begin{table}[htbp]\centering
	...
	\begin{tabular}{c|ccccccc}
		...
		\input{code/tables/output/robustness_city.tex}
...
\begin{table}[htbp]\centering
	...
	\label{table:Robustness by listing characteristics}
...
\begin{table}[htbp]\centering
	...
	\label{table: Yearly Revenue Estimates}
	\begin{tabular}{c|cccc}
		\toprule
		
		\input{code/output/yearly_revenue.tex}
