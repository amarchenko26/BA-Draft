...
\begin{document}
	...
	\input{1_intro_lit}
	\label{lit}
	% results paragraph in intro updated according to new #s 
	% same for the number of reviews/robustness section 
	% End of intro, update contributions to reviewer-side analysis, and finish "testing alternative hypotheses" part. 
